...
path_to_dir = '/scratch/local1/output/22_07_27_comp_cost_particle_scaling_v00'
...
for ii,item in enumerate(cases):
    ...
    case_run_time = datetime.strptime(case_run_time,"%H:%M:%S.%f").timestamp()
...
plt.savefig('comp_cost_particle_scaling_analysis.png')