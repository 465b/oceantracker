...
#-----------------------------------------------    
run_name = '22_11_01_depth_losses_v57'
#-----------------------------------------------
...
# v58
# reducing deault watt'age to 1W from 10W
...
for stickiness in np.linspace(0, 1, 20):
...
for light_limitation_threshold in np.linspace(10, 100, 20):
...
for light_limited_culling_prop in np.linspace(3.56e-06, 3.56e-04, 20):
    df = pd.concat([df, pd.DataFrame({'initial_size': 5e-5,
                                 'stickiness': 1,
                                 'light_limitation_threshold': 30,
