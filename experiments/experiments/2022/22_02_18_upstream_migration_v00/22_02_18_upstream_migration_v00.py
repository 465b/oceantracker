...
params={
    'shared_params' :{
		            ...
		            "output_file_base": "22_02_18_upstream_migration_v00temp",
...
splitting_ratios = [1e-4]

cases = []
for sinking in sinking_parameters:
    for splitting in splitting_ratios:
        # polygons after 7 are high salinity - aka particles die instantly (sustained_salinity < 0.1PSU)
        for ii in np.arange(8): 
            release_polygon = statistical_polygon_list[ii]
            cases.append({
                "particle_release_groups": [
                    {
                        "class_name": "oceantracker.particle_release_groups.polygonRelease.PolygonRelease",
                        "points": release_polygon['points'],
                        "pulse_size": 1000,
                        "z_min": -1,
                        "z_max": 1,
                        "release_interval": 0
                ...
                "user_trajectory_modifiers": [
                    ...
                    },
                    {
                        ...
                        "split_status_greater_thanmin_status_to_split": 4,
                    ...
                    # mortality for particles stranded of dry cells
                    # none
                ]
            })
