...
#%%
#-----------------------------------------------
run_name = '22_06_02_retention_v01'
#-----------------------------------------------
...
splitting_ratios = np.linspace(min_splitting_ratio,max_splitting_ratio,sa_resolution)
        ...
        "trajectory_modifiers": [
            {
                ...
                "split_status_greater_than": 'on_bottom',
