...
#%%
#-----------------------------------------------
run_name = '22_12_08_retention_v19'
#-----------------------------------------------w
...
#v18
# based on v15 and set light starvation to 3 months (3*28*24h)

#v19
# based on v15 and disabled light starvation completely
...
params={
	...
	"base_case_params": {
        ...
        "particle_properties": [
                ...
                #     'max_time_wo_light': 3600*24*28*3,
                #     'initial_value': 0
                #     },
