...
params={
    'shared_params' :{
		            ...
		            "output_file_base": "21_11_09_sa_verticle_spawning_v10",
...
splitting_ratios = np.append([0],np.linspace(1e-5,1e-2,9))
    ...
    for splitting in splitting_ratios:
        cases.append({
            ...
            "user_trajectory_modifiers": [
                ...
                #},
                ## natural mortality for particles
                #{
                #    "class_name": "oceantracker.user_trajectory_modifiers.cullParticles.ParticleCull",
                #    "cull_interval": 100,
                #    "status_to_cull": 10,
                #    "fraction_to_cull": 0.0001,
                }
            ]
        })
