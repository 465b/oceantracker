...
release_polygon_list = deepcopy(statistical_polygon_list)
...
params={
    'shared_params' :{
		            ...
		            "output_file_base": "22_04_22_light_dryness_frictionresusp_tests_v02",
...
splitting_ratios = np.linspace(0,1e-3,5)
