...
params={
    'shared_params' :{
		            ...
		            "output_file_base": "22_03_29_resuspsension_test_v00",
		            "root_output_dir": "/scratch/local1/outpuot/",
		            "debug": False,
		            "processors": 8,
		            "replicates": 1,
...
sinking = 1e-2
critical_friction_velocities = [1e-2,1e-2,1e-1]

cases = []
for friction in critical_friction_velocities:
    cases.append({
        ...
        #    {
        #        'class_name': 'oceantracker.user_trajectory_modifiers.resuspension.FrictionVelocity'
        #    }
        ],
        "user_trajectory_modifiers": [
            {
                "class_name": "oceantracker.user_trajectory_modifiers.resuspension.BasicResuspension",
                "critical_friction_velocity": friction
            }
        ]
    })
