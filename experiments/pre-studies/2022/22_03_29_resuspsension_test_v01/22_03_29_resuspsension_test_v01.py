...
params={
    'shared_params' :{
		            ...
		            "output_file_base": "22_03_29_resuspsension_test_v01",
...
sinking = -1e-2
critical_friction_velocities = np.linspace(1e-3,3e-2,10)
...
statsPlot.plot_sa_total_polycount(runCaseInfo,[2,5])
