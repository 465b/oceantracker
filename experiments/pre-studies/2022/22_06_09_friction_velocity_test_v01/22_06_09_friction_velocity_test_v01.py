...
#-----------------------------------------------
run_name = '22_06_09_friction_velocity_test_v01'
#-----------------------------------------------
...
# Monotonic migration
monotonic_cases = []
for velocity in np.linspace(0,0.2,20):
...
print('start')
runInfo_file_name = '/scratch/local1/output/22_06_09_friction_velocity_test_v01/22_06_09_friction_velocity_test_v01_runInfo.json'
