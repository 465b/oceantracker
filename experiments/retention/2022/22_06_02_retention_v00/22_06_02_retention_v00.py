...
#-----------------------------------------------
run_name = '22_06_02_retention_v02'
#-----------------------------------------------
...
runInfo_file_name = '/scratch/local1/output/22_06_02_retention_v02/22_06_02_retention_v02_runInfo.json'
for ii,velocity in enumerate(cases):
    case = load_output_files.get_case_info_file_name(runInfo_file_name,ncase = ii)
    particle_plot.animate_particles(case,movie_file='retention_test'+str(ii)+'.mp4')